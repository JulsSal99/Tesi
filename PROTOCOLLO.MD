...
**Inizialmente**:
 - dichiarare le seguenti informazioni a scopo di raccolta dati:
   - sesso [M/F/ND]:
   - età:
   - madrelingua inglese [SI/NO]:
   - tipologia di lavoro: [cassiera,...]
   - ambiente lavorativo: [privato/pubblico]
   - sei spesso a lavoro a contatto con i clienti: [si/no]
   - [forse no] Quanto stai al PC, alla TV, giornali.
...
13. **futuro**
    - (generica, corta) Dove ti vedi in futuro?
      - *ENG*: Where do you see yourself in the future?
14. **ipotesi storica**
    - (specifica, corta) Se dovessi scegliere un periodo storico in cui vivere, quale sceglieresti?
      - *ENG*: If you had to choose a historical period to live in, which one would you choose?
15. **musei/arte**
